				  ...
				  <div class="item text-center">
                     <div class="avatar">
                        <picture>
                           ...
                           <img class="rounded-circle-partner img-responsive basic center-block" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/loading.svg" data-src="{ROW.image}" alt="{ROW.title}" />
                        </picture>
                     </div>
                     <div class="text">
                        <h3>{ROW.title}</h3>
