...
<form class="form-inline m-bottom">
    ...
    <a href="{URL_ADD}" class="btn btn-primary">{LANG.cat_add}</a> <a href="{URL_EXCEL}" target="_blank" class="btn btn-primary <!-- BEGIN: btn_disabled -->disabled<!-- END: btn_disabled -->"><em class="fa fa-file-excel-o">&nbsp;</em>{LANG.task_export}</a>
</form>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr onclick="nv_table_row_click(event, '{VIEW.link_view}', false);" class="pointer <!-- BEGIN: warning -->danger<!-- END: warning -->">
                    ...
                    <td>
                        <div onclick="" title="{LANG.update_qick_progress}" class="progress">
                          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="{VIEW.progress}"
                          aria-valuemin="0" aria-valuemax="100" style="width:{VIEW.progress}%">
                            {VIEW.progress}%
                          </div>
                        </div>
                    </td>
