	...
	<div class="table-responsive">
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					<td class="text-right text-strong">{LANG.content_title1}</td>
					<td>
						<input type="text" id="idtitle1" name="title1" value="{DATA.title1}" class="form-control w500">
					</td>
				</tr>
				<tr>
					<td class="text-right text-strong">{LANG.content_title2}</td>
					<td>
						<input type="text" id="idtitle2" name="title2" value="{DATA.title2}" class="form-control w500">
					</td>
				</tr>
				<tr>
					<td class="text-right text-strong">{LANG.content_more}</td>
					<td>
						<input type="text" id="more" name="more" value="{DATA.more}" class="form-control w500">
					</td>
				</tr>
				<tr>
