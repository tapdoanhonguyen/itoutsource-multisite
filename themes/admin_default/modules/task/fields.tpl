...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            <!-- BEGIN: loop -->
            <tr>
                <td class="text-center"><select class="form-control" id="id_weight_{ROW.fid}" onchange="nv_chang_field({ROW.fid});">
                        <!-- BEGIN: weight -->
                ...
                <td class="text-center"><input type="checkbox" onclick="nv_change_status({ROW.fid}, 'required');" id="change_status_required_{ROW.fid}" {ROW.required}/></td>
                <td class="text-center"><input type="checkbox" onclick="nv_change_status({ROW.fid}, 'show_profile');" id="change_status_show_profile_{ROW.fid}" {ROW.show_profile}/></td>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{LANG.field_id}:</td>
                    <td><input class="form-control" type="text" value="{DATAFORM.field}" name="field"{DATAFORM.fielddisabled}><span class="help-block">{LANG.field_id_note}</span></td>
                </tr>
                <!-- END: field -->
                <tr>
                    <td>{LANG.field_title}</td>
                    <td><input class="form-control required" type="text" value="{DATAFORM.title}" name="title"></td>
                </tr>
                <tr>
                    <td>{LANG.field_description}:</td>
                    <td><textarea cols="60" rows="3" name="description" class="form-control">{DATAFORM.description}</textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul style="list-style: none; padding: 0">
                            ...
                            <!-- END: loop -->
                        </ul>{LANG.field_type_note} <!-- END: field_type --> {FIELD_TYPE_TEXT}
                    </td>
                </tr>
                <tr id="classfields"{DATAFORM.classdisabled}>
                    <td>{LANG.field_class}</td>
                    <td><input class="form-control validalphanumeric" type="text" value="{DATAFORM.class}" name="class" maxlength="50"></td>
                </tr>
        ...
        <table class="table table-striped table-bordered table-hover" id="textfields"{DATAFORM.display_textfields}>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="form-control" maxlength="255" type="text" value="{DATAFORM.default_value}" name="default_value"></td>
                </tr>
                <tr id="max_length">
        ...
        <table class="table table-striped table-bordered table-hover" id="numberfields"{DATAFORM.display_numberfields}>
            ...
            <tbody>
                <tr>
                    ...
                    <td><label><input type="radio" value="1" name="number_type"{DATAFORM.number_type_1}>{LANG.field_integer}</label>&nbsp; <label><input type="radio" value="2" name="number_type"{DATAFORM.number_type_2}> {LANG.field_real}</label></td>
                </tr>
                <tr>
                    <td>{LANG.field_default_value}</td>
                    <td><input class="form-control required number" maxlength="255" type="number" value="{DATAFORM.default_value_number}" name="default_value_number"></td>
                </tr>
                <tr>
        ...
        <table class="table table-striped table-bordered table-hover" id="datefields"{DATAFORM.display_datefields}>
            ...
            <tbody>
                <tr>
                    <td>{LANG.field_default_value}:</td>
                    <td><label><input type="radio" value="1" name="current_date"{DATAFORM.current_date_1}> {LANG.field_current_date}</label>&nbsp; <label><input type="radio" value="0" name="current_date"{DATAFORM.current_date_0}> {LANG.field_default_date}</label>&nbsp;
        ...
        <table class="table table-striped table-bordered table-hover" id="choicetypes"{DATAFORM.display_choicetypes} >
            ...
            <tr>
                ...
                <td>
                    <!-- BEGIN: choicetypes_add --> <select class="form-control" name="choicetypes">
                        <!-- BEGIN: choicetypes -->
                        <option {CHOICE_TYPES.selected} value="{CHOICE_TYPES.key}">{CHOICE_TYPES.value}</option>
                        <!-- END: choicetypes -->
                </select> <!-- END: choicetypes_add --> <!-- BEGIN: choicetypes_add_hidden --> {FIELD_TYPE_SQL}<input type="hidden" name="choicetypes" value="{choicetypes_add_hidden}" /> <!-- END: choicetypes_add_hidden -->
                </td>
            </tr>
        </table>
