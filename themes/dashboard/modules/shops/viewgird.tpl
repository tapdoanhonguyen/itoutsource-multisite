    ...
    <div class="col-sm-12 col-md-{NUM}">
        <div class="thumbnail">
            ...
            <div class="caption text-center">
                ...
                <a href="javascript:;" class="btnEstimate" class="btn btn-primary" data-product="{ROW.id}" data-type="0">Báo giá</a>
                <a href="javascript:;" class="btnEstimate" class="btn btn-primary" data-product="{ROW.id}" data-type="1">Lái thử</a>
            </div>
        </div>
    </div>
    <!-- END: loop -->
