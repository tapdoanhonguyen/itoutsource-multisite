...
<form class="form-horizontal" action="{ACTION}" method="post">
	...
	<input type="hidden" name="is_contacts" value="{ROW.is_contacts}" />
    <div class="panel panel-default">
        ...
        <div class="panel-body">
			...
			<div class="form-group">
                ...
                <div class="col-sm-19 col-md-20">
                    <input class="form-control" type="text" name="code" value="{ROW.code}" readonly />
                </div>
            </div>
            ...
            <div class="form-group">
			 ...
			 <div class="form-group">
                <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.share_customer}</strong></label>
                <div class="col-sm-19 col-md-20">
                   <select class="form-control select2" name="share_customer" style="width: 100%">
						<option value="0">-- {LANG.selected_share_customer} --</option>
                                <!-- BEGIN: share_customer -->
                                <option value="{customer.key}"{customer.selected}>{customer.value}</option>
                                <!-- END: share_customer -->
                    </select>
                </div>
            </div>
