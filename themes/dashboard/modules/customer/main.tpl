        ...
        <table class="table table-striped table-bordered table-hover row-click">
            <thead>
                <tr>
                    ...
                    <th>{LANG.number_service}</th>
                    <th>
						 <!-- BEGIN: code_no --> <em class="fa fa-sort">&nbsp;</em> <!-- END: code_no --> <!-- BEGIN: code --> <!-- BEGIN: desc --> <em class="fa fa-sort-numeric-desc">&nbsp;</em> <!-- END: desc --> <!-- BEGIN: asc --> <em class="fa fa-sort-numeric-asc">&nbsp;</em> <!-- END: asc --> <!-- END: code --> 
						<a href="{SORTURL.code}" title="">{LANG.code}</a>
					</th>
            ...
            <tbody>
                ...
                <tr onclick="nv_table_row_click(event, '{VIEW.link_view}', false);">
                    ...
                    <td><a href="{VIEW.link_service}">{LANG.view_serviece} ({VIEW.service} )</a></td>
                    <td>{VIEW.code}</td>
                    ...
                    <td>
						...
						<!-- BEGIN: senmail -->
						<div>{LANG.ngay_gui_mai_gan_nhat} {VIEW.ngaygannhat} {LANG.date}</div>
						<!-- END: senmail -->
                    </td>
                    ...
                    <td class="text-center">
                        <!-- BEGIN: admin -->
                        <i class="fa fa-edit fa-lg">&nbsp;</i> <a href="{VIEW.link_edit}">{LANG.edit}</a> </br> <em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="{VIEW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a>
                        <!-- END: admin -->
                    </td>
                </tr>
                <!-- END: loop -->
...
<script>
	...
	$('#frm-search').submit(function(){
		window.location.href = '{URLSEARCH}' + '?q=' + $('input[name="q"]').val().replace(' ', '+') + '&is_contact=' + $('input[name="is_contact"]').val() + '&type_id=' + $('select[name="type_id"]').val() + '&care_staff=' + $('select[name="care_staff"]').val(); return false;
	});
</script>
<!-- END: main -->