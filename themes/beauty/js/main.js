...
$(window).on('load', function() {
    ...
    $(".blHoa .service").each(function(index){
        var inz = index;
        $(this).attr("data-slick-index",inz);
    });
    $("#blSlide").on('swipe',function(){
        var index_now= $(this).slick("slickCurrentSlide");
        $(".blHoa .service").removeClass("active");
        $(".blHoa .service").each(function(key){
            if(index_now==(key)){
                $(this).addClass("active");
            }
        });
    });
    $(".blHoa .service").click(function(){
        $(".blHoa .service").removeClass("active");
        $(this).addClass("active");
        var index=$(this).attr("data-slick-index");
        $('#blSlide').slick("slickGoTo",parseInt(index));
    });
});
