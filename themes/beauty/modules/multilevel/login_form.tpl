	...
	<div class="form-group loginCaptcha">
		<div class="middle text-center clearfix">
			...
			<div class="nv-recaptcha-compact">
				<div id="{RECAPTCHA_ELEMENT}" data-toggle="recaptcha" data-pnum="4" data-btnselector="[type=submit]" data-size="compact"></div>
			</div>
			<!-- END: compact -->
		</div>
	</div>
