...
if (!nv_function_exists('nv_kuteshop_product')) {

    /**
     * nv_block_config_kuteshop_blocks()
     *
     * @param mixed $module
     ...
     *
     */
    function nv_block_config_kuteshop_blocks($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_kuteshop_blocks_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     *
     */
    function nv_block_config_kuteshop_blocks_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     *
     */
    function nv_kuteshop_product($block_config)
    {
        global $nv_Cache, $nv_Cache, $site_mods, $global_config, $lang_module, $lang_global, $module_config, $module_config, $module_name, $module_info, $global_array_shops_cat, $db_config, $my_head, $db, $pro_config, $money_config, $array_wishlist_id;
        $block_config['module'] = $block_config['selectmod'];
        $module = $block_config['module'];
        $mod_data = $site_mods[$module]['module_data'];
        $mod_file = $site_mods[$module]['module_file'];

		if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.block_relates_product.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.block_relates_product.tpl')) {
		...
		$xtpl = new XTemplate('global.block_relates_product.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_kuteshop_product($block_config);
}
