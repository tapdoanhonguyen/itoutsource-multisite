										...
										<div class="product-main-wrapper">
											<div class="title-wrapper" style="height: 50.375px;">
												<p class="name product-title woocommerce-loop-product__title">
													<a href="//smartlineco.com/san-pham/may-in-da-chuc-nang-pantum-bm5100adn/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">{ROW.title}</a>
												</p>
											</div>
