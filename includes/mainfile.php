...
require NV_ROOTDIR . '/domain/' . NV_SERVER_NAME . '/' . NV_DATADIR . '/config_global.php';
...
define('NV_GROUPSDETAIL_GLOBALTABLE', $db_config['dbsystem'] . '.' . $db_config['prefix'] . '_users_groups_detail');
