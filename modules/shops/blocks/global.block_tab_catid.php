...
if (!nv_function_exists('nv_tab_catid')) {
    ...
    function nv_tab_catid($block_config)
    {
        ...
        $mod_file = $site_mods[$module]['module_file'];
			...
			if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.block_tab_catid.tpl')) {
            $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.block_tab_catid.tpl')) {
			...
			$xtpl = new XTemplate('global.block_tab_catid.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
