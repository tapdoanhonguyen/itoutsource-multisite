...
class Purchases_model extends Model {
	...
	public function addPurchase($data, $items) {
		$stmt = $this -> db -> prepare('INSERT INTO ' . $this -> db_prefix . '_' . $this -> mod_data . '_purchases (reference_no, date, supplier_id, warehouse_id, note, total, product_discount, order_discount_id, order_discount, total_discount, product_tax, order_tax_id, order_tax, total_tax, shipping, grand_total, paid, status, payment_status, created_by, updated_by, updated_at, attachment, payment_term, due_date, return_id, surcharge, return_purchase_ref, purchase_id, return_purchase_total, cgst, sgst, igst) VALUES (:reference_no, :date, :supplier_id, :warehouse_id, :note, :total, :product_discount, :order_discount_id, :order_discount, :total_discount, :product_tax, :order_tax_id, :order_tax, :total_tax, :shipping, "", "", :status, :payment_status, :created_by, :updated_by, :updated_at, :attachment, :payment_term, :due_date, 0, "", :return_purchase_ref, :purchase_id, "", :cgst, :sgst, :igst)');
