...
if($global_config['idsite'] == 0){
	...
	$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_warehouses(
	  ...
	  price_group_id int(11) DEFAULT NULL,
	  store_id int(11) NOT NULL DEFAULT '0',
	  whidsite int(11) NOT NULL DEFAULT '0',
	  PRIMARY KEY (id),
	  KEY id (id)
	) ENGINE=InnoDB";
	...
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'product_prefix', 'SH')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'customer_prefix', 'C')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'sales_prefix', 'SALES')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'quote_prefix', 'QT')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'purchase_prefix', 'PC')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'transfer_prefix', 'TS')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'delivery_prefix', 'DL')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'payment_prefix', 'PM')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'return_prefix', 'RT')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'returnp_prefix', 'RTP')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'expense_prefix', 'EP')";
	$sql_create_module[] = "INSERT IGNORE INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('vi', '" . $module_name . "', 'modules_shops', 'shops')";
