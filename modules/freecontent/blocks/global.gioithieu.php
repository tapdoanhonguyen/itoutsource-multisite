...
if (!nv_function_exists('nv_block_gioithieu')) {
    /**
     ...
     * @return
     */
    function nv_block_config_gioithieu($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_gioithieu_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     * @return
     */
    function nv_block_gioithieu($block_config)
    {
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_gioithieu($block_config);
}
