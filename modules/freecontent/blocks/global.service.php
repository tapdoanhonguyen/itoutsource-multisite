...
if (!nv_function_exists('nv_block_service')) {
    /**
     ...
     * @return
     */
    function nv_block_config_service($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_service_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     * @return
     */
    function nv_block_service($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.service.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.service.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block.service.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_service($block_config);
}
