...
if (!nv_function_exists('nv_block_gioithieu2')) {
    /**
     ...
     * @return
     */
    function nv_block_config_gioithieu2($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_gioithieu2_submit($module, $lang_block)
    {
        global $nv_Request;
     ...
     * @return
     */
    function nv_block_gioithieu2($block_config)
    {
		...
		if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.gioithieu2.tpl')) {
			$block_theme = $global_config['module_theme'];
		} elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.gioithieu2.tpl')) {
			$block_theme = $global_config['site_theme'];
		} else {
			$block_theme = 'default';
		}

		$xtpl = new XTemplate('block.gioithieu2.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_gioithieu2($block_config);
}
