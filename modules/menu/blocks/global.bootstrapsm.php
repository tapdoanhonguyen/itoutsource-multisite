...
if (!nv_function_exists('nv_menu_bootstrap_sm')) {
    /**
     ...
     * @return string
     */
    function nv_menu_bootstrap_sm($block_config)
    {
        global $nv_Cache, $global_config, $site_mods, $module_info, $module_name, $module_file, $module_data, $lang_global, $catid, $home;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/menu/global.bootstrapsm.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/menu/global.bootstrapsm.tpl')) {
        ...
        $xtpl = new XTemplate('global.bootstrapsm.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/menu');
...
if (defined('NV_SYSTEM')) {
    ...
    $content = nv_menu_bootstrap_sm($block_config);
