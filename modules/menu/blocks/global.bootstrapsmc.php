...
if (!nv_function_exists('nv_menu_bootstrap_smc')) {
    /**
     ...
     * @return string
     */
    function nv_menu_bootstrap_smc($block_config)
    {
        global $nv_Cache, $global_config, $site_mods, $module_info, $module_name, $module_file, $module_data, $lang_global, $catid, $home;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/menu/global.bootstrapsmc.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/menu/global.bootstrapsmc.tpl')) {
...
if (defined('NV_SYSTEM')) {
    ...
    $content = nv_menu_bootstrap_smc($block_config);
