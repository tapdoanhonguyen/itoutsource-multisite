 ...
 * @return string
 */
function nv_smartline_menu_blocks($block_config)
{
        ...
        foreach ($list_cats as $cat) {
            if (empty($cat['parentid'])) {
                if (!empty($cat['subcats'])) {
                    $submenu_active = [];
                    $html_content = nv_smartline_smenu_blocks($block_config['block_name'], $list_cats, $cat['subcats'], $submenu_active, $block_theme);
                ...
                $cat['class'] = nv_smartline_menu_blocks_active($cat);
 ...
 * @return string
 */
function nv_smartline_menu_blocks_active($cat)
{
 ...
 * @return string
 */
function nv_smartline_smenu_blocks($style, $list_cats, $list_sub, &$submenu_active, $block_theme)
{
    ...
    foreach ($list_cats as $cat) {
        ...
        if (in_array((int) $catid, $list, true)) {
            $list_cats[$catid]['class'] = nv_smartline_menu_blocks_active($list_cats[$catid]);
            ...
            if (!empty($list_cats[$catid]['subcats'])) {
                $tree = nv_smartline_smenu_blocks($style, $list_cats, $list_cats[$catid]['subcats'], $submenu_active, $block_theme);
