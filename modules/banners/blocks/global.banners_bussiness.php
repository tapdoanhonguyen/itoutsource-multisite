...
if (!nv_function_exists('nv_block_data_config_banners_bussiness')) {
    /**
     ...
     * @return string
     */
    function nv_block_data_config_banners_bussiness($module, $data_block, $lang_block)
    {
     ...
     * @return array
     */
    function nv_block_data_config_banners_bussiness_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
     ...
     * @return string
     */
    function nv_block_global_banners_bussiness($block_config)
    {
        ...
        if (!empty($array_banners_content)) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/banners/global.banners_bussiness.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/banners/global.banners_bussiness.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('global.banners_bussiness.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/banners');
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_global_banners_bussiness($block_config);
}
